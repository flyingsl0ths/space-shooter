...
impl Plugin for GraphicsPlugin {
    fn build(&self, app: &mut App) {
        app.add_startup_system_to_stage(StartupStage::PreStartup, load_texture_sheets);
    }
}
...
fn load_texture_sheets(
    ...
    let obstacles = TextureAtlas::from_grid(obstacles, Vec2::new(120., 98.), 1, 4);
    let obstacles2 = TextureAtlas::from_grid(obstacles2, Vec2::new(45., 43.), 1, 6);
    let projectiles = TextureAtlas::from_grid(projectiles, Vec2::new(13., 37.), 1, 2);
